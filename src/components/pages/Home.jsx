...
const Home = ({isAuthenticated}) => {
  return (
    <>
      <section className="h-[300px] bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply mb-8">
