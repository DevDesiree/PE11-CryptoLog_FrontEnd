...
const PaginationComponent = ({ currentPage, perPage, totalItems, onPageChange }) => {
        ...
        <div className="flex justify-center mt-4">
            <ul className="inline-flex justify-center -space-x-px text-sm">
                ...
                {Array.from({ length: pageCount }, (_, i) => (
                    <li key={i}>
                        <button
                            className={`flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white ${currentPage === i + 1 ? 'text-blue-600 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:text-white' : ''
                                }`}
